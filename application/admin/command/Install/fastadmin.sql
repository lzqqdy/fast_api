...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '异常上报表' ROW_FORMAT = Compact;
...
-- Records of fa_admin
-- ----------------------------
INSERT INTO `fa_admin` VALUES (1, 'admin', 'Admin😀', 'bf6eac67de0c3bf5c05818ab421b8b22', '995f43', '/assets/img/avatar.png', 'lzqqdy@qq.com', 0, 1570846143, '127.0.0.1', 1492186163, 1570867438, '43e42f89-60b0-43ba-9ab1-c06f21460c12', 'normal');
...
INSERT INTO `fa_auth_rule` VALUES (85, 'file', 0, 'command', '在线命令管理', 'fa fa-terminal', '', '', 1, 1567502540, 1567502540, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (86, 'file', 85, 'command/index', '查看', 'fa fa-circle-o', '', '', 0, 1567502540, 1567502540, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (87, 'file', 85, 'command/add', '添加', 'fa fa-circle-o', '', '', 0, 1567502540, 1567502540, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (88, 'file', 85, 'command/detail', '详情', 'fa fa-circle-o', '', '', 0, 1567502540, 1567502540, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (89, 'file', 85, 'command/execute', '运行', 'fa fa-circle-o', '', '', 0, 1567502540, 1567502540, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (90, 'file', 85, 'command/del', '删除', 'fa fa-circle-o', '', '', 0, 1567502540, 1567502540, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (91, 'file', 85, 'command/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1567502540, 1567502540, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (93, 'file', 92, 'general/crontab/index', '查看', 'fa fa-circle-o', '', '', 0, 1567502547, 1567502547, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (94, 'file', 92, 'general/crontab/add', '添加', 'fa fa-circle-o', '', '', 0, 1567502547, 1567502547, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (95, 'file', 92, 'general/crontab/edit', '编辑 ', 'fa fa-circle-o', '', '', 0, 1567502547, 1567502547, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (96, 'file', 92, 'general/crontab/del', '删除', 'fa fa-circle-o', '', '', 0, 1567502547, 1567502547, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (97, 'file', 92, 'general/crontab/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1567502547, 1567502547, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (98, 'file', 0, 'test', '测试管理', 'fa fa-circle-o\r', '', '', 1, 1567503524, 1567503524, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (99, 'file', 98, 'test/index', '查看', 'fa fa-circle-o', '', '', 0, 1567503524, 1567503524, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (100, 'file', 98, 'test/recyclebin', '回收站', 'fa fa-circle-o', '', '', 0, 1567503524, 1567503524, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (101, 'file', 98, 'test/add', '添加', 'fa fa-circle-o', '', '', 0, 1567503524, 1567503524, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (102, 'file', 98, 'test/edit', '编辑', 'fa fa-circle-o', '', '', 0, 1567503524, 1567503524, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (103, 'file', 98, 'test/del', '删除', 'fa fa-circle-o', '', '', 0, 1567503524, 1567503524, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (104, 'file', 98, 'test/destroy', '真实删除', 'fa fa-circle-o', '', '', 0, 1567503524, 1567503524, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (105, 'file', 98, 'test/restore', '还原', 'fa fa-circle-o', '', '', 0, 1567503524, 1567503524, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (106, 'file', 98, 'test/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1567503524, 1567503524, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (107, 'file', 2, 'general/database', '数据库管理', 'fa fa-database', '', '可在线进行一些简单的数据库表优化或修复,查看表结构和数据。也可以进行SQL语句的操作', 1, 1567563264, 1567563264, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (108, 'file', 107, 'general/database/index', '查看', 'fa fa-circle-o', '', '', 0, 1567563264, 1567563264, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (109, 'file', 107, 'general/database/query', '查询', 'fa fa-circle-o', '', '', 0, 1567563264, 1567563264, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (110, 'file', 107, 'general/database/backup', '备份', 'fa fa-circle-o', '', '', 0, 1567563264, 1567563264, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (111, 'file', 107, 'general/database/restore', '恢复', 'fa fa-circle-o', '', '', 0, 1567563264, 1567563264, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (116, 'file', 2, 'abnormal', '上报异常记录', 'fa fa-exclamation-triangle', '', '', 1, 1569290801, 1569290944, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (117, 'file', 116, 'abnormal/index', '查看', 'fa fa-circle-o', '', '', 0, 1569290801, 1570846593, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (118, 'file', 116, 'abnormal/recyclebin', '回收站', 'fa fa-circle-o', '', '', 0, 1569290801, 1570846593, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (119, 'file', 116, 'abnormal/add', '添加', 'fa fa-circle-o', '', '', 0, 1569290801, 1570846593, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (120, 'file', 116, 'abnormal/edit', '编辑', 'fa fa-circle-o', '', '', 0, 1569290801, 1570846593, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (121, 'file', 116, 'abnormal/del', '删除', 'fa fa-circle-o', '', '', 0, 1569290801, 1570846593, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (122, 'file', 116, 'abnormal/destroy', '真实删除', 'fa fa-circle-o', '', '', 0, 1569290801, 1570846593, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (123, 'file', 116, 'abnormal/restore', '还原', 'fa fa-circle-o', '', '', 0, 1569290801, 1570846593, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (124, 'file', 116, 'abnormal/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1569290801, 1570846593, 0, 'normal');
...
CREATE TABLE `fa_command`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '在线命令表' ROW_FORMAT = Compact;
...
-- Records of fa_user
-- ----------------------------
INSERT INTO `fa_user` VALUES (1, 1, '', 'admin', '萧小咩😍', 'c13f62012fd6a8fdf06b3452a94430e5', 'rpR6Bv', 'admin@163.com', '13888888888', '/uploads/20191012/0c16f62f9be52a153a93f4c9a682ea51.jpg', 0, 0, '2017-04-15', '', 0.00, 0, 1, 1, 1516170492, 1516171614, '127.0.0.1', 0, '127.0.0.1', 1491461418, 0, 1570867456, NULL, '', '1', '');
