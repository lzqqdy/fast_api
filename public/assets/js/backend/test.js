define(['jquery', 'bootstrap', 'backend', 'table', 'form', 'ueditor','editable'], function ($, undefined, Backend, Table, Form, UE) {
                ...
                columns: [
                    [
                        ...
                        {field: 'category_ids', title: __('Category_ids')},
                        {
                            ...
                            title: __('Week'),
                            searchList: {
                                "monday": __('Week monday'),
                                "tuesday": __('Week tuesday'),
                                "wednesday": __('Week wednesday')
                            },
                        ...
                        },
                        {
                            ...
                            title: __('Hobbydata'),
                            searchList: {
                                "music": __('Hobbydata music'),
                                "reading": __('Hobbydata reading'),
                                "swimming": __('Hobbydata swimming')
                            },
                            operate: 'FIND_IN_SET',
                            formatter: Table.api.formatter.label
                        },
                        ...
                        },
                        {
                            field: 'state',
                            title: __('State'),
                            searchList: {"0": __('State 0'), "1": __('State 1'), "2": __('State 2')},
                            formatter: Table.api.formatter.normal
                        },
                        {
                            field: 'buttons',
